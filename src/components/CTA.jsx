  ...
  return (
    <section className="final-cta">
      ...
      <div className="shell">
        ...
        <div><a className="button button--light" href="#contact">Start a conversation <ArrowUpRight size={18} /></a><a className="button button--outline-light" href="#services">Explore services</a></div>
      </div>
    </section>
  );
}
